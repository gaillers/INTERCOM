...
// порядок подкл scss / css
const styleFiles = [
 './src/styles/common/fonts.scss',
 './src/styles/common/swiper-custom.scss',
...
// порядок подкл js
const jsFiles = ['./src/js/main.js','./src/js/lib.js','./src/js/uForm.js'];
...
gulp.task('default', gulp.series('del', gulp.parallel('pages','normalize','styles', 'scripts', 'img-compress','font','fonts','ttf'), 'watch'));